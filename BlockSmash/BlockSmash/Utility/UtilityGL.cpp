...
bool UtilityGL::keyboardControl()
{
...
GLuint UtilityGL::arrayBufferHandling (const GLfloat *bufferData, unsigned int size)
{
    // バッファオブジェクトへのハンドル
    GLuint bufferHandle;
...
int UtilityGL::createWindow(int window_width, int window_height)
{
    if( !glfwInit() ){
